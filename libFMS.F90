...
module fms
  ...
  use xgrid_mod, only: fms_xgrid_xmap_type => xmap_type, &
                       ...
                       fms_xgrid_xgrid_count => xgrid_count, & !repetative ?
                       fms_xgrid_some => some, &
  ...
  !> fms2_io  ! i feel like all of the 'fms_fms2' is very repetative
  ...
  use mpp_domains_mod, only: fms_mpp_domains_domain_axis_spec => domain_axis_spec, &
                             ...
                             fms_mpp_domains_get_UG_io_domain => mpp_get_UG_io_domain, & !why some captial and some lowercase?
